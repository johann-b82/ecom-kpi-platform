...
import { simulateConnectAction } from '@/app/(shell)/katalog/actions';

export const dynamic = 'force-dynamic';

export default async function KatalogVerbindungenPage() {
  const items = await listConnections('katalog');
  return (
