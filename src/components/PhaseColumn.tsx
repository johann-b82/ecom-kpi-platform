...
export function PhaseColumn({ phase }: { phase: PhaseKpis }) {
  ...
  return (
    <div className="flex flex-1 flex-col gap-3">
      <Link href={`/verkauf/dashboard/phase/${phase.phase}`} className="rounded-lg border border-neutral-300 bg-neutral-100 p-3 text-center hover:bg-neutral-200 dark:border-neutral-700 dark:bg-neutral-800/40 dark:hover:bg-neutral-800/70">
