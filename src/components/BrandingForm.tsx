    ...
    <section>
      ...
      <div className="space-y-4 rounded-lg border border-neutral-200 bg-white p-4 dark:border-neutral-800 dark:bg-neutral-900">
        ...
        <div className="flex items-center gap-3">
          <label className="w-56 text-sm text-neutral-700 dark:text-neutral-300">Logo</label>
        ...
        {/* Headline */}
        <div className="flex items-center gap-3">
          <label className="w-56 text-sm text-neutral-700 dark:text-neutral-300">Headline</label>
